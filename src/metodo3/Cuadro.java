...
public class Cuadro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tabla1.getColumnModel().getColumnCount() > 0) {
            tabla1.getColumnModel().getColumn(0).setHeaderValue(" i");
            tabla1.getColumnModel().getColumn(1).setHeaderValue("Xi");
            tabla1.getColumnModel().getColumn(2).setHeaderValue("f(x)");
            tabla1.getColumnModel().getColumn(3).setHeaderValue("f´(x)");
            tabla1.getColumnModel().getColumn(4).setHeaderValue("Xi-1");
            tabla1.getColumnModel().getColumn(5).setHeaderValue("error");
        }

        jLabel1.setText("                Iteraccion");
        ...
        jLabel3.setText("                       METODO DE NEWTON");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/gg.png"))); // NOI18N
    ...
    private void calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcularActionPerformed
        // TODO add your handling code here:
         OperacionTabla gg=new OperacionTabla();
        int i=Integer.parseInt(iteracion.getText());
        double xi1=Double.parseDouble(dato.getText());
       
        tabla1.setModel(new AbstracModel(gg.getTablaNewton( i, xi1)));
