 ...
 * @author Dext
 */
public class mtPuntoFijo extends JFrame{
    ...
    JLabel txtErrorFin=new JLabel("Limite del Error");
    JTextField esErrorFin=new JTextField(5);
    JButton bCalcular=new JButton("Calcular");
    JTable tabla= new JTable();
    JScrollPane sp, res;
    
    String [] cabecera={"Iteraciones","x-1","x=g(x)", "Error"};//Se crea la cabecera en un vector
    CalculoMetodo2 calculos=new CalculoMetodo2();
    public mtPuntoFijo()
    {
        super ("Metodo 2");
        ...
        pBot.setBorder(BorderFactory.createEmptyBorder(10, 50, 10, 50));
        ...
        pGrid.setBorder(BorderFactory.createEmptyBorder(-1, 100, 0, 100));
        
        JPanel pTab =new JPanel();
        pTab.setLayout(new FlowLayout());
        pTab.add(sp);
                
        JPanel pGeneral=new JPanel();
        BorderLayout bord=new BorderLayout();
        pGeneral.setLayout(bord);
        pGeneral.add(pGrid, BorderLayout.NORTH);
        pGeneral.add(pBot, BorderLayout.CENTER);
        pGeneral.add(pTab, BorderLayout.SOUTH);//Se crea la tabla y se retorna
